...
const DisplayProductList = (props: DisplayProductProps[]): JSX.Element => (
  <SimpleGrid w="100%" columns={[1, null, 2]} spacingX="50px" spacingY="50px" justifyItems="center">
    {props &&
      ...
      Object.values(props).map((eachObjData) => <DisplayProduct key={eachObjData.productId} {...eachObjData} />)}
  </SimpleGrid>
);
